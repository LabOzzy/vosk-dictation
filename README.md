...
### 🧠 Использование: просто оставьте в фоне

- Программа **работает в фоне**, пока значок в трее 🟢 активен  
- Удерживай `Alt` 1.2 сек — начнётся запись  
- Удержи `Alt` снова — запись остановится, текст вставится  
- Текст вставляется **в активное окно** — поставь курсор заранее  
- **Нет ограничения по времени записи**

💡 **Добавьте в автозапуск**, чтобы диктовка всегда была под рукой  
❌ Нажмите “Остановить” в трее — и программа полностью завершится
